const FAQ_card = (props) => {
    return (
        <>
            <label htmlFor={'check' + props.id} className="faqCard h-max flex flex-col w-full px-5 pt-4 pb-2 ring-1 ring-slate-400 gap-2 shadow-md rounded-md">
                <input type="checkbox" id={'check' + props.id} className="hidden invisible checkBox" />
