...
function App() {
  ...
  const [expanded, setExpState] = useState(false)
        ...
        <>
          ...
          <div className="FAQS">
            ...
            <div className="flex justify-center w-full">
              <div onClick={() => { !expanded ? setExpand(true) : setExpand(false) }} className="border border-purp text-purp p-1 px-3 cursor-pointer rounded-full">{expanded? 'Collapse' :'Expand'} all</div></div>
